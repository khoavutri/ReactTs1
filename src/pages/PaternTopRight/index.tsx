...
const PaternTopRight = ({ data, colorIcon, stikyColor }: Props) => {
  ...
  return (
    <div style={{ width: '100%', backgroundColor: 'white', color: 'black', overflowY: 'auto' }} 
      ...
      <div style={{ margin: '5px 5px', width: 'calc(100% - 10px)', display:data?'flex':'none', overflow: 'auto' }}>
        <div style={{ width: '50%', display: 'flex', flexDirection: 'column' }}>
          ...
          <p>
            <strong style={{ color: colorIcon }}>Department:</strong> {data&&data.assDepartment ? data.assDepartment : ''}
          </p>
          <p>
        ...
        <div style={{ width: '50%' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between' }}>
            ...
            <p>
              <strong style={{ color: colorIcon }}>Gender:</strong> {data&&data.pGender && data.pGender === 'F' ? 'Nữ' : 'Nam'}
            </p>
          </div>
          <p>

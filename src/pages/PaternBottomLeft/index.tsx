...
const PaternBottomLeft = ({data,colorIcon,setDulieu}: Props) => {
    const [indam,setIndam] = useState(-1);

  return  (  <div style={{ width: '100%', overflow: 'auto', backgroundColor: 'white', color: 'black' }} className='Patient-ngangvip'>

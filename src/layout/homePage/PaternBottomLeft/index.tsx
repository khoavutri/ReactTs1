...
type Props = { data: any; colorIcon: string; setDulieu: any; resetListShow: any; listShow: any };

const PaternBottomLeft = ({ data, colorIcon, setDulieu, listShow, resetListShow }: Props) => {
            ...
            <th>
              <div color={colorIcon} style={{ display: 'flex' }}>
                <div className='PaternTopLeft_table-setAn'>
                  ...
                  <div className='PaternTopLeft_table-an' style={{ bottom: '0' }}>
                    {listShow &&
...
export default memo(PaternBottomLeft);
